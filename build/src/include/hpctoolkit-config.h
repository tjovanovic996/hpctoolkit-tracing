...
/* HPCToolkit version */
#define HPCTOOLKIT_VERSION "develop"

/* HPCToolkit version string */
#define HPCTOOLKIT_VERSION_STRING "A member of HPCToolkit, version develop"
...
#define PACKAGE_STRING "hpctoolkit develop"
